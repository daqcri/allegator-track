...
class RedisTokenSeed(object):
    ...
    def putTokens(self):
        ...
        """
        RedisCache.createHash('dataset_map', '', {'dataset_url': 'https://docs.google.com/spreadsheets/d/15S1ywe6UEefs3k9j103ZlYWNsfvOOXVZSTX4H5Pch5M/export?format=csv', 'dataset_name': 'sample_dataset'})
        RedisCache.createHash('runset_map', '', {"checked_algo": {"Accu": ["0.2", "0", "100", "0.5", "false", "true", "true", "false"]}, "general_config": ["0.001", "0.8", "1", "0.4"]})
        RedisCache.setKV('uploaded_datasets', [])
        RedisCache.createHash('result_map', '', {'runset_id': None})
