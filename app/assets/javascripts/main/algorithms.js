var algorithms = [
  ...
  {id:13, name: "LTM", description: "LTM uses Bayesian Networks for estimating the truth. LTM iterate over a fixed number of iterations, and compute the value confidence by sampling using Collapsed Gibbs Sampling process.", params: [
    ...
    {name: 'Burn-in', value: 100, dataType: 'int', min: 0, max: 1000, desc: 'Collapsed Gibbs Sampling burn-in period (Number of discarded first set of iterations). Must be significantly less than the number of iterations.'},
    {name: 'Thinning', value: 9, dataType: 'int', min: 0, max: 1000, desc: 'Collapsed Gibbs Sampling thinning parameter (Number of iterations to be skipped every time before considering an iteration result). Must be significantly less than the number of iterations.'},
  ]},
]
